...
| -------- | ------------------------------------ | ---------------------------------- | -------- | --------- |
| variant  | `primary`, `secondary` or `tertiary` | palette variation of the hello bar | no       | `primary` |
| children | ReactNode                            | message shown inside the hello bar | no       | -         |
| action   | { label: string, onClick: Function } | the action of the hello bar        | no       | -         |
