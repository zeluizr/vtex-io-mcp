...
| ------------- | -------- | ------------------------------------------------------------------ | -------- | ------- |
| actionText    | string   | the text of the toast action                                       | no       | -       |
| onActionClick | function | the function that handles the action click                         | no       | -       |
| closeOnAction | boolean  | determines whether close the toast on action click or not          | no       | false   |
