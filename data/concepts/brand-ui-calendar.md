...
| -------- | --------- | ------------------------------------------------------ | -------- | ------------- |
| onChange | function  | the function that handles changes on the date selected | no       | -             |
| day      | number    | the day that will be displayed                         | no       | current day   |
| month    | number    | the month that will be displayed                       | no       | current month |
| year     | number    | the year that will be displayed                        | no       | current year  |
| events   | Events    | events that should have a mark on the calendar         | no       | []            |
| locale   | string    | internationalization of the dates and weekdays         | no       | `en`          |
| disabled | boolean   | whether the calendar is disabled or not                | no       | `false`       |
