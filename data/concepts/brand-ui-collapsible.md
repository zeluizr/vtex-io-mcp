...
| ------------- | ------------------------------------------------------- | ----------------------------- | --------- | -------- |
| label         | ReactNode                                               | content of the disclosure     | -         | yes      |
| prefix        | (props: { size: number; sx: SxStyleProp }) => ReactNode | prefix icon of the header     | -         | no       |
| suffix        | (props: { size: number; sx: SxStyleProp }) => ReactNode | suffix icon of the header     | -         | no       |
| size          | `regular` or `small`                                    | size of the header            | `regular` | no       |
| arrowPosition | `right` or `left`                                       | position of the arrow icon    | `right`   | no       |
| arrowAlign    | `center`, `start` or `end`                              | arrow icon vertical alignment | `center`  | no       |
...
| -------- | ----------- | --------------------- | -------- |
| children | ReactNode   | what's being toggled  | no       |
| sx       | SxStyleProp | Theme-ui style prop   | no       |
