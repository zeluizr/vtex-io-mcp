...
See our guide about how to [develop an app](https://developers.vtex.com/docs/guides/vtex-io-documentation-developing-an-app) or our [Learning Center](https://learn.vtex.com/docs/course-store-block-lang-en) to learn more about this process.
