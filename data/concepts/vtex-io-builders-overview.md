...
> Each builder version has one of the following statuses: Beta, Stable, Deprecated, Decommissioned, and Non-functional. Verify [Builder version statuses](https://developers.vtex.com/docs/guides/vtex-io-documentation-builder-version-statuses) before using a builder.
