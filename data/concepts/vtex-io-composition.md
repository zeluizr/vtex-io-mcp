...
> Note: The `composition` property determines how child blocks are organized, not the position of the parent block itself.
...
> Recommendation: For greater flexibility, use the [`slots`](#slots) composition whenever possible.
